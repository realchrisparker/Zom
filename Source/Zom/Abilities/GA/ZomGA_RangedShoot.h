...
/**
 * Ranged weapon fire. The actual line trace/projectile and ammo-consumption logic depends on which
 * weapon is equipped (Section 7's GameplayInventorySystem plugin, not yet built) and isn't fabricated here - this
