...
#include "ZomGameplayEffectBase.generated.h"


/**
 * Shared effect base for the four Zom effects. GameplayEffects are mostly data (duration policy,
 * modifiers, tags), not code, so unlike UZomGameplayAbilityBase there's little runtime logic to hoist here - its
 ...
 */
UCLASS()
class ZOM_API UZomGameplayEffectBase : public UGameplayEffect
{
	GENERATED_BODY()
};
